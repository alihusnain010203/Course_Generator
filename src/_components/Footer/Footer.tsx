  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
      <div className="text-center">
        <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">Customise Your Study</h2>
  
        <p className="mx-auto mt-4 max-w-sm text-gray-500">
          Generate a custom learning path with AI-driven course creation. Tailor your learning to fit your unique goals and pace.
        </p>
  ...
  <Link href='/dashboard'>
      ...
      >
        ...
        <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
          ...
          <li>
            <Link
              href="https://www.github.com/alihusnain010203"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:opacity-75"
            >
